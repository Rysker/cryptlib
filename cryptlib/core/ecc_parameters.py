"""
Container for NIST specified Elliptic Curves parameters.
Includes P-256, P-384, and P-521.
"""
...
@dataclass
class CurveParams:
    """Parameters for a NIST elliptic curve."""
    name: str
    p: int
    a: int
    b: int
...
CURVES = {
    ...
    "P-521": CurveParams(
        "P-521",
        p=int("01ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", 16),
        a=int("01fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffc", 16),
...
def get_curve(name: str) -> CurveParams:
    """Return CurveParams for given curve name."""
